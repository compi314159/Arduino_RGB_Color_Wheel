...
void loop() {
  xvalue = analogRead(Y_pin)-505.5;
  yvalue = analogRead(X_pin)-507;
  float color = abs((float)atan((float)yvalue/xvalue));  
  if(xvalue == -505.50 && yvalue ==0){
    color = 3.14159265358979;
  }
  ...
  if(color<=4.18879020479&&color>=2.09439510239){
    greenValue = 0;
  }
  if(redColor<=4.18879020479&&redColor>=2.09439510239){
    redValue = 0;
    }
  if(blueColor<=4.18879020479&&blueColor>=2.09439510239){
    blueValue = 0;
    } 
  if(redValue >= 255){
    redValue = 255;
  ...
  if((abs(xvalue) == 0.50) && (abs(yvalue) <= 1)){
    greenValue = 0;
    redValue = 0;
    blueValue = 0;
  }
